...
/* $Id: hook_settings.inc.php 23271 2007-01-13 04:15:30Z dop $ */
...
$GLOBALS['settings'] = array(
    'prefssection' => array(
        'type' => 'section',
        'title' => 'Preferences for the advise template set',
        'xmlrpc' => False,
        'admin' => False
    ),
    ...
    'display_type' => array(
        'type' => 'select',
        'label' => "Choisir le type d'affichage des fenêtres",
        'name' => "display_type",
        'values' => $display_type,
        'default' => 'popin',
        'help' => 'Permet d\'afficher les fenêtres en mode normal (popup) ou en mode jquery (popin)'
    )
);
