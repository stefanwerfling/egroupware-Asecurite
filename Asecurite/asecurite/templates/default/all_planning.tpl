            ...
            <table cellpadding="0" cellspacing="0" border="0" class="display" id="tableContent">
                <thead>
                    <tr>
                        ...
                        <th width="10%">Paniers</th>
                        <th width="15%">Nombre d'heures jour</th>
                        <th width="15%">Nombre d'heures nuit</th>
                        <th width="15%">Nombre d'heures jour dimanche</th>
                        <th width="15%">Nombre d'heures nuit dimanche</th>
                        <th width="15%">Site</th>
